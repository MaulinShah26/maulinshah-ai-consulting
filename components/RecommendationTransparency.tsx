...
export default function RecommendationTransparency() {
  ...
  return (
    <main className="min-h-screen bg-[#f6f7fb] text-[#17211f]">
      ...
      {showBag ? <BagPanel bag={bag} products={bagProducts} subtotal={bagSubtotal} onRemove={removeOneFromBag} onClose={() => setShowBag(false)} /> : null}
